...
var file_books_books_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x02, 0x69, 0x64, 0x32, 0xe1, 0x01, 0x0a, 0x0b, 0x42, 0x6f,
	...
	0x70, 0x74, 0x79, 0x22, 0x00, 0x12, 0x26, 0x0a, 0x05, 0x57, 0x61, 0x74, 0x63, 0x68, 0x12, 0x0c,
	0x2e, 0x62, 0x6f, 0x6f, 0x6b, 0x73, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x1a, 0x0b, 0x2e, 0x62,
	0x6f, 0x6f, 0x6b, 0x73, 0x2e, 0x42, 0x6f, 0x6f, 0x6b, 0x22, 0x00, 0x30, 0x01, 0x42, 0x11, 0x5a,
	0x0f, 0x62, 0x6f, 0x6f, 0x6b, 0x73, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x62, 0x6f, 0x6f, 0x6b, 0x73,
...
var file_books_books_proto_depIdxs = []int32{
	...
	0, // 5: books.BookService.Watch:input_type -> books.Empty
	2, // 6: books.BookService.List:output_type -> books.BookList
	0, // 7: books.BookService.Insert:output_type -> books.Empty
	1, // 8: books.BookService.Get:output_type -> books.Book
	0, // 9: books.BookService.Delete:output_type -> books.Empty
	1, // 10: books.BookService.Watch:output_type -> books.Book
...
func (*UnimplementedBookServiceServer) Watch(*Empty, BookService_WatchServer) error {
